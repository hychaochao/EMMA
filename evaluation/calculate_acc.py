...
def main():
    ...
    # output
    parser.add_argument('--results_dir', type=str, default='/Users/chao/Desktop/Ashanghai/MultiBench/opensource/github/EMMA/results/test-time-compute/gpt-best-of-4')
